    ...
    public void run() {
       ...
       while(loginCheck==true){
        ...
        if (opSelection == 1){
            ...
            if (housePrice==1){
                System.out.println(service.getTotalPricesOfHouses());
            } else if (housePrice==2) {
                System.out.println(service.getAvgMsquareOfHouses());
            }else {
            ...
            if (villaPrice==1){
                System.out.println(service.getTotalPricesOfVillas());
            } else if (villaPrice==2) {
                System.out.println(service.getAvgMsquareOfVillas());
            }else {
                System.out.println("Lütfen geçerli bir değer giriniz!");
                break;
            }
